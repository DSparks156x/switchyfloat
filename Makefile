...
lefloat.vescpkg: src lisp/package.lisp package_README-gen.md ui.qml
ifeq ($(OLDVT), 1)
	"$(VESC_TOOL)" --buildPkg "lefloat.vescpkg:lisp/package.lisp:ui.qml:0:package_README-gen.md:Lefloat"
else
...
clean:
	rm -f lefloat.vescpkg package_README-gen.md ui.qml
	$(MAKE) -C src clean
