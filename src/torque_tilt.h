...
void torque_tilt_configure(TorqueTilt *tt, const LefloatConfig *config);

void torque_tilt_update(TorqueTilt *tt, const MotorData *motor, const LefloatConfig *config);
